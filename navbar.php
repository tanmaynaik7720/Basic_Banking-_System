<!-- navbar --> 
      ...
      <a class="navbar-brand" href="index.php" style="color : black;"><b>SPARKS BANK/TANMAY NAIK</b></a>
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="createuser.php" style="color : black;"><b>New User</b></a>
              </li>
              <li class="nav-item">
